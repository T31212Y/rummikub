...
import de.htwg.se.rummikub.model.playingfieldComponent.{BoardInterface, TableInterface, TokenStackInterface, PlayingFieldInterface, PlayingFieldFactoryInterface}

class StandardPlayingFieldBuilder(factory: PlayingFieldFactoryInterface) extends PlayingFieldBuilderInterface {
